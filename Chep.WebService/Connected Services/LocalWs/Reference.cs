...
namespace LocalWs
{
    ...
    public interface IService1
    {
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<LocalWs.WsArchiveEvrimModel>> GetArchiveEvrimIdListAsync(string UserNameWs, string PasswordWs, System.DateTime ArchiveDate);
        ...
        System.Threading.Tasks.Task<LocalWs.WsArchiveEvrimModel> GetArchiveEvrimAsync(string UserNameWs, string PasswordWs, int ArchiveId);
        ...
        System.Threading.Tasks.Task<LocalWs.WsArchiveEvrimModel> GetArchiveEvrimFileAsync(int ArchiveId, string TescilNo, byte[] ArchiveData);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<LocalWs.IService1>, LocalWs.IService1
    {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<LocalWs.WsArchiveEvrimModel>> GetArchiveEvrimIdListAsync(string UserNameWs, string PasswordWs, System.DateTime ArchiveDate)
        {
            return base.Channel.GetArchiveEvrimIdListAsync(UserNameWs, PasswordWs, ArchiveDate);
        }
        
        public System.Threading.Tasks.Task<LocalWs.WsArchiveEvrimModel> GetArchiveEvrimAsync(string UserNameWs, string PasswordWs, int ArchiveId)
        {
            return base.Channel.GetArchiveEvrimAsync(UserNameWs, PasswordWs, ArchiveId);
        }
        
        public System.Threading.Tasks.Task<LocalWs.WsArchiveEvrimModel> GetArchiveEvrimFileAsync(int ArchiveId, string TescilNo, byte[] ArchiveData)
        {
