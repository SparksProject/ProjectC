...
select 
  ...
  ,gdetay.UrunKod as ProductNo,gdetay.MenseUlke as CountryOfOrigin,Urun.Uom as Uom,cdetay.Miktar as ActualQuantity,
  ...
  isnull(cikis.KapMiktari,1) as NumberOfPackages, cdetay.SiraNo as ItemNumber,'' as ProducerCompanyNo,'' as ProducerCompany,
  (giris.TpsNo +'/'+ cast(gdetay.TpsCikisSiraNo as nvarchar(3))) as IncentiveLineNo
