...
select 
DATEDIFF(day,SureSonuTarihi,GETDATE()) AS KalanSure,Giris.StokGirisId,ReferansNo,TPSNo,TPSDurum,BasvuruTarihi,SureSonuTarihi,GumrukKod,Detay.BeyannameNo,
Detay.BeyannameTarihi,BelgeAd,BelgeSart,TPSAciklama,IthalatciFirma,IhracatciFirma,KapAdet,StokGirisDetayId,TPSSiraNo,TPSBeyan,EsyaCinsi,detay.EsyaGtip,FaturaNo,
