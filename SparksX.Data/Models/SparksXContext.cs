...
{
    public partial class SparksXContext : DbContext
    {
        public SparksXContext()
        {
        }

        public SparksXContext(DbContextOptions<SparksXContext> options)
            : base(options)
        {
        }

        public SparksXContext(DbContextOptions options)
    : base(options)
        {
        }
